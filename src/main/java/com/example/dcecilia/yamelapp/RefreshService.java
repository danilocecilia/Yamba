   ...
   public RefreshService(){
    ...
    class FriendsTimeline implements TimelineProcessor {
        ...
        public void onTimelineStatus(YambaClient.TimelineStatus status) {
            ...
            if (uri != null) {
                Intent intent = new Intent("com.example.dcecilia.yamelapp.NEW_STATUS");
                intent.putExtra(StatusContract.Columns.USER, status.getUser()).putExtra(StatusContract.Columns.TEXT, status.getMessage());
